...
const companyLogos = [
  ...
  { name: "facebook", className: "", rotate: "rotate-3" },
  { name: "CSS Winner", className: "", rotate: "-rotate-3" },
  { name: "CSSDesignAwards", className: "", rotate: "rotate-2" },
  { name: "/thoughtworks", className: "", rotate: "-rotate-2" },
  { name: "AUTODESK", className: "", rotate: "rotate-1" },
];

export default function AboutSection() {
  return (
    <section className="relative px-6 lg:px-24 py-20  overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center space-y-6">
        ...
        <h2 className="text-xl_title lg:text-xxl_title font-semibold leading-tight">
        ...
        <p className="text-gray-700 max-w-xl text-base lg:text-regular">
        ...
        <div className="mt-12 w-full">
          <p className="text-p font-bold mb-6 text-left lg:text-center">PREVIOUSLY WORKED ON</p>
